...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/missmiya_bot")
                                ]
                                ]
                            )
                        )
        ...
        buttons = [[
                    InlineKeyboardButton("⚙️ ʙᴏᴛ ᴜᴘᴀᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ⚙️", url="https://t.me/+d8zuVyrBBcNkYzI1")
                ],[
                    InlineKeyboardButton("📂 ᴊᴏɪɴ ꜰᴏʀ ᴜᴘᴀᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 📂", url="https://t.me/+rjw2I6MtjW8xYzRl")
                ],[      
                    InlineKeyboardButton("🔰 ᴮᴼᵀ ᴬᴮᴼᵁᵀ ᴾᴬᴺᴱᴸ 🔰", callback_data="about")
                  ]]
